...
def delTrans():
    ...
    while transCheck():
        ...
        dispTrans(1)
        print(f"\nPlease select which transaction to remove by entering 1-{len(transactions)}, or enter '0' to return to the menu.")
        userInput = int(input())
        userInput -= 1
...
def editTrans():
    while transCheck():
        ...
        # Ask user if they want to remove more transactions
        print("Would you like to edit another transaction? (Yes / No)")
        userInput = input().lower()
